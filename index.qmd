...
description: "Elizabeth has lived in the Pacific Northwest for 13 years and is passionate about helping clients in the Greater Seattle area navigate a competitive real estate market. Originally from Dallas, TX, Elizabeth has a bachelor’s degree in Economics from DePauw University and a master’s degree in Higher Education Administration from Indiana University."
about:
  id: hero-heading
  template: jolla
  image-width: 30em
...
:::{#hero-heading}
M: 317-250-4362 | [elizabeth.donaldson@compass.com](mailto:elizabeth.donaldson@compass.com)
:::
